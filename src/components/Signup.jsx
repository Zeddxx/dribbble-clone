    ...
    const loginWithGoogle = async() => {
      ...
      try {
        ...
        toast({
          ...
          description: 'Now that you are signed in successfully you can create a Dribbble posts and more!',
          // variant: 'success'
        })
      }
    }
  return (
    <div className="flex w-full h-full justify-center xmd:justify-start items-center">
